...
SYSTEM_PRESETS: tuple[ConversionPreset, ...] = (
    ...
    ConversionPreset(
        ...
        scope=PresetScope.SYSTEM,
        description="Чистый экспорт для презентации и артбордов. Полноцветный PNG без PNG-8, с мягким сжатием и лимитом до 2048 px.",
        options=ConversionOptions(
            optimize=True,
            compress_level=7,
            resize_mode=ResizeMode.MAX_SIDE,
    ...
    ConversionPreset(
        ...
        scope=PresetScope.SYSTEM,
        description="Компактный экспорт для мобильных и lightweight сборок. Даунскейл до 1024 px, optimize и умеренное сжатие.",
        options=ConversionOptions(
            optimize=True,
            compress_level=7,
            resize_mode=ResizeMode.MAX_SIDE,
